...
export const en: Record<TranslationKey, string> = {
  ...
  'create.noPitchesTitle': 'No pitches found',
  'create.noPitchesMessage': 'There are currently no pitches added in this district. Please select another district.',
  'create.pitchesLoadFailed': "Couldn't load pitches. Please try again.",
  ...
  'messages.searchPlaceholder': 'Search by person or match name',
  ...
  'notifications.clearAllTitle': 'Clear all',
  'notifications.clearAllConfirm': 'Notifications on this page will be cleared. Follow and join requests awaiting your response stay in the list until you respond.',
  'notifications.clearAllAction': 'Clear',
  'notifications.bulkFailed': "Couldn't complete the action. Please try again.",
  ...
  'chat.reactionTitle': 'React',
  'chat.reactionRemove': 'Remove reaction',
  'chat.reactionFailed': "Couldn't save the reaction. Please try again.",
  ...
  'blocked.goToList': 'Blocked Users',
  'blocked.chatNotice': 'You blocked this person earlier. You cannot send messages.',
  'settings.reports.title': 'Reports / Add Pitch',
  ...
  'admin.reports.messageDeleted': 'Message deleted.',
  'admin.reports.messageDeleteFailed': 'Report approved but the message could not be deleted (it may already be gone).',
  'admin.reports.deleteMessageTitle': 'Delete this message?',
  'admin.reports.deleteMessageConfirm': 'Approving permanently deletes the reported message from the chat. This cannot be undone.',
  'admin.reports.pageOf': '{current} / {total}',
  'admin.title': 'Reports / Add Pitch',
  'admin.tabs.reports': 'Reports',
  'admin.tabs.addPitch': 'Add Pitch',
  'admin.tabs.suggestions': 'Suggestions',
  'admin.pitches.intro': 'Add it while you are there: grab your location, type the name, save.',
  'admin.pitches.submit': 'Add Pitch',
  'admin.pitches.addedTitle': 'Pitch added',
  'admin.pitches.addedBody': 'The pitch is now in the list and can be picked when creating a match.',
  'admin.pitches.failedTitle': 'Could not add pitch',
  'admin.pitches.duplicateTitle': 'A pitch is already nearby',
  'admin.pitches.duplicateBody': 'There is already a pitch very close to this location. Adding the same pitch twice splits its matches across two records.',
  'admin.pitches.addAnyway': 'Add anyway',
  'admin.suggestions.empty': 'No pending suggestions.',
  'admin.suggestions.by': 'Suggested by',
  'admin.suggestions.noDistrict': 'No district given',
  'admin.suggestions.noCoords': 'no location',
  'admin.suggestions.review': 'Review and Add',
  'admin.suggestions.reviewTitle': 'Review suggestion',
  'admin.suggestions.approve': 'Approve and Add Pitch',
  'admin.suggestions.reject': 'Reject',
  'admin.suggestions.rejectTitle': 'Reject this suggestion?',
  'pitchForm.name': 'Pitch name',
  'pitchForm.namePlaceholder': 'e.g. Camdibi Astroturf',
  'pitchForm.district': 'District',
  'pitchForm.districtPlaceholder': 'Select a district',
  'pitchForm.districtSearch': 'Search district',
  'pitchForm.districtNotFound': 'No district found.',
  'pitchForm.location': 'Location',
  'pitchForm.useMyLocation': 'Use My Location',
  'pitchForm.locationHint': 'Drag the pin or tap the map to adjust.',
  'pitchForm.locationEmpty': 'No location yet. Using Use My Location at the pitch gives the best result.',
  'pitchForm.locationTitle': 'Location',
  'pitchForm.locationDenied': 'Location permission was not granted.',
  'pitchForm.locationFailed': 'Could not get your location. Please try again.',
  'pitchForm.address': 'Address',
  'pitchForm.addressPlaceholder': 'Street, number, neighbourhood',
  'pitchForm.phone': 'Phone',
  'pitchForm.price': 'Hourly price',
  'pitchForm.features': 'Features',
  'pitchForm.missingTitle': 'Missing information',
  'pitchForm.missingName': 'Pitch name is required.',
  'pitchForm.missingDistrict': 'Please select a district.',
  'pitchForm.missingLocation': 'Location is required. Use My Location or pick it on the map.',
  'pitchForm.missingAddress': 'Address is required.',
  'pitchForm.missingPhone': 'Phone is required.',
  'pitchForm.missingPrice': 'Hourly price is required.',
  'pitchForm.missingFeatures': 'Please select at least one feature.',
  'suggestPitch.cta': 'Missing a pitch? Suggest one',
  'suggestPitch.title': 'Suggest a Pitch',
  'suggestPitch.intro': 'Know an astroturf pitch that is not listed? Tell us and it will be added after review.',
  'suggestPitch.submit': 'Send Suggestion',
  'suggestPitch.thanksTitle': 'Thanks',
  'suggestPitch.thanksBody': 'We received your suggestion. It will be added to the list after review.',
  'suggestPitch.failedTitle': 'Could not send suggestion',
  'suggestPitch.guest': 'You need to sign in to suggest a pitch.',
