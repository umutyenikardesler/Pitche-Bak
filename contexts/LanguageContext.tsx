...
const translations = {
  tr: {
    ...
    'pitches.priceDisclaimer': 'Saha ücreti zaman zaman değişiklik gösterebilir. Rezervasyon yaparken teyit ettiriniz. Fiyat değişikliği olursa yanından güncelleyebilirsiniz.',
  ...
  en: {
    ...
    'pitches.priceDisclaimer': 'Pitch prices may change from time to time. Please confirm when making a reservation. You can also update the price here if it changes.',
