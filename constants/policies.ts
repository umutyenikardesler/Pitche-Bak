...
> = {
  terms: {
    ...
    blocks: [
      ...
      { type: "h3", text: "5) Şikayetler" },
      {
        type: "p",
        text: "İhlal ve şikayet bildirimleri 24 saat içinde incelenir. Raporlanan içerikler değerlendirilip gerekli işlemler (içerik kaldırma, uyarı, hesap kısıtlama vb.) uygulanır.",
      },
      { type: "h3", text: "6) İletişim" },
  ...
  community: {
    ...
    blocks: [
      ...
      { type: "h3", text: "5) Şikayet süreci" },
      {
        type: "p",
        text: "Şikayetler 24 saat içinde incelenir. Uygunsuz içerik tespit edildiğinde gerekli yaptırımlar uygulanır.",
      },
      { type: "h3", text: "6) Bildirim" },
